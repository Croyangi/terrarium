...
execute if entity @s[tag=tr.voidllager,tag=tr.voidllager.casting,tag=!tr.voidllager.bartering,tag=!tr.no_ai] if entity @a[gamemode=!creative,gamemode=!spectator,distance=..16,tag=!tr.voidllager.friendly] run function tr:entity/voidllager/spell_cast
execute if entity @s[tag=tr.voidllager,tag=tr.voidllager.bartering,tag=!tr.no_ai] run function tr:entity/voidllager/bartering/bartering
