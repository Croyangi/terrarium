...
execute if entity @s[tag=tr.voidllager.friendly] if entity @e[type=wandering_trader,tag=tr.voidllager,distance=..16] at @e[type=wandering_trader,tag=tr.voidllager,nbt={HurtTime:10s}] run particle minecraft:angry_villager ~ ~1.5 ~ .3 .3 .3 0 5
