...
execute if entity @p[gamemode=!creative,gamemode=!spectator,nbt={Inventory:[{Slot:102b,id:"minecraft:elytra"}],FallFlying:1b}] run scoreboard players set #tr.temp tr.dummy 101
