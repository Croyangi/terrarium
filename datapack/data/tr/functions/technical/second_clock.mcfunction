...
execute if data storage tr:storage {root:{gamerules:{doCustomMobSpawning:1b}}} as @e[type=#tr:natural_mob_spawning] at @s run function tr:entity/natural_mob_spawning/second_clock
